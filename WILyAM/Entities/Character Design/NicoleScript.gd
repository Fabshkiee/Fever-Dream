...
# ==== SOUND COOLDOWNS ====
var spray_sfx_cooldown: float = 0.0
var spray_sfx_cooldown_time: float = 0.5  # Minimum time between spray sounds
var dash_sfx_cooldown: float = 0.0
var dash_sfx_cooldown_time: float = 1.0   # Minimum time between dash sounds
var jump_sfx_cooldown: float = 0.0
var jump_sfx_cooldown_time: float = 0.3   # Minimum time between jump sounds
...
func _process(delta):
	...
	spray_sfx_cooldown = max(spray_sfx_cooldown - delta, 0.0)
	dash_sfx_cooldown = max(dash_sfx_cooldown - delta, 0.0)
	jump_sfx_cooldown = max(jump_sfx_cooldown - delta, 0.0)
...
# ==== IMPROVED SOUND FUNCTIONS WITH COOLDOWNS ====
func play_footstep_sound():
	if run_sounds.is_empty() or not run_sfx_1 or run_sfx_1.playing:
		return
...
func play_spray_sfx():
	if spray_sfx and spray_sfx_cooldown <= 0.0:
		spray_sfx.play()
		spray_sfx_cooldown = spray_sfx_cooldown_time

func play_dash_sfx():
	if dash_sfx and dash_sfx_cooldown <= 0.0:
		dash_sfx.play()
		dash_sfx_cooldown = dash_sfx_cooldown_time

func play_jump_sfx():
	if jump_sfx and jump_sfx_cooldown <= 0.0:
		jump_sfx.play()
		jump_sfx_cooldown = jump_sfx_cooldown_time
